---
title: FB Comments
description: A sample mockup of a facebook like chat navigation panel
tags: ['navigation panel', 'layout', 'tailwindcss', 'vue', 'chat panel', 'tailwindcss', 'vuejs']
categories: ['layout', 'panel', 'nav', 'side panel']
author: jasenmichael
author_img: /img/jasenmichael_profile.jpg
author_urls: [{'name': 'github', 'url': 'https://github.com/jasenmichael'}]
image: /img/FbComments.png
---

```vue [./components/snippets/Fb Comments.vue]
<template>
  <div>
