...
```vue [./components/snippets/Alerts With Tailwind.vue]
<template>
  <div class="flex flex-col">
    <div class="flex bg-yellow max-w-sm mb-4">
    ...
    <div class="flex bg-green-lighter max-w-sm mb-4">
      ...
      <div class="w-auto text-grey-darker items-center p-4">
        ...
        <p class="leading-tight">
          ...
          consequuntur dolore doloribus eius fugit, porro quidem repellat
          temporibus unde?
        </p>
      </div>
    </div>
    ...
    <div class="flex bg-teal-lighter max-w-sm mb-4">
      ...
      <div class="w-auto text-grey-darker items-center p-4">
        ...
        <p class="leading-tight">
          ...
          labore, voluptatem. Deserunt illum laborum maxime?
        </p>
      </div>
    </div>
